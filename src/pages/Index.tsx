    ...
    <Layout>
      ...
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          {/* Cyan accent orbs in opposite corners - matched opacity to purple orbs */}
          <div className="hidden md:block absolute top-0 left-0 w-[300px] h-[300px] lg:w-[400px] lg:h-[400px] opacity-[0.06] lg:opacity-[0.08] blur-3xl rounded-full bg-accent transform -translate-x-1/3 -translate-y-1/3" />
